 ...
 * shared URLs work everywhere — the header's back chevron always returns to
 * the inbox. (No AppShell here: on mobile the shell would waste vertical space
 * we need for the composer; on desktop the focused view is a fine tradeoff.)
 */
export default function ThreadDeepLinkPage({
  params,
}: {
  ...
  const initial = mockThreads.find((t) => t.id === threadId);
      ...
      const stop = setTimeout(() => {
        ...
        setThread((prev) => {
          ...
          const incoming: Message = {
            ...
            content: "Je viens de voir ton message, je te réponds vite.",
